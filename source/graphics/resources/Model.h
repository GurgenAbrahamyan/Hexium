...
public:
    ...
    void addSubMesh(int id, RenderMesh* mesh, Material* material, Vector3 position,  Quat rotation,  Vector3 scale, Mat4 localTransform) {
        subMeshes.push_back({ id, mesh, material, position, rotation, scale, localTransform});
    }
